...
db.version(1).stores({
    ...
    userStore:'id, visitedCanteens, favouriteCanteens, userDiet, userAllergies, plannedMeals, notify',
    });

//initialize userStore with empty values
db.userStore.put({
    id: 1,
    visitedCanteens: [],
    favouriteCanteens: [],
    userDiet: '',
    userAllergies: [],
    plannedMeals: [9285966, 9285967, 9285968, 9285969],
    notify: false
});
